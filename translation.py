...
def translate_row(row):
    ...
    try:
        time.sleep(0.25)  # Delay of 250ms (4 requests per second)
...
def process_all_parts():
    """Process all parts in the PARTS_FOLDER."""
...
if __name__ == "__main__":
    ...
    # Step 1: Split the data into parts
    split_data(INPUT_FILE, num_parts=100)

    # Step 2: Process each part and translate
    process_all_parts()
